...
class AboutPageTablet extends StatefulWidget {
  const AboutPageTablet({Key? key}) : super(key: key);

  @override
  State<AboutPageTablet> createState() => _AboutPageTabletState();
}

class _AboutPageTabletState extends State<AboutPageTablet>with TickerProviderStateMixin {
  @override
